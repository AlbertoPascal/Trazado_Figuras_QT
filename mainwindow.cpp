...
{
    int extra = 25;
    scene->addLine(250,250,225,300);
    scene->addLine(250,250,275,300);
    scene->addLine(225,300,275,300);
    scene->addLine(250+extra,250+extra,225+extra,300+extra);
    scene->addLine(250+extra,250+extra,275+extra,300+extra);
    scene->addLine(225+extra,300+extra,275+extra,300+extra);
    scene->addLine(250,250,250+extra,250+extra);
    scene->addLine(225,300,225+extra,300+extra);
    scene->addLine(275,300,275+extra,300+extra);

    transformada->addLine(250+centrox,250+centroy,centrox+225,centroy+300);
    transformada->addLine(centrox+250,centroy+250,centrox+275,centroy+300);
    transformada->addLine(centrox+225,centroy+300,centrox+275,centroy+300);
    transformada->addLine(centrox+250+extra,centroy+250+extra,centrox+225+extra,centroy+300+extra);
    transformada->addLine(centrox+250+extra,centroy+250+extra,centrox+275+extra,centroy+300+extra);
    transformada->addLine(centrox+225+extra,centroy+300+extra,centrox+275+extra,centroy+300+extra);
    transformada->addLine(centrox+250,centroy+250,centrox+250+extra,centroy+250+extra);
    transformada->addLine(centrox+225,centroy+300,centrox+225+extra,centroy+300+extra);
    transformada->addLine(centrox+275,centroy+300,centrox+275+extra,centroy+300+extra);
}
